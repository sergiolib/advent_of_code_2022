...
def get_scores_matrix_and_relevant_points(content):
    ...
    return ret, start_point, end_point
...
scores_matrix, start_point, end_point = get_scores_matrix_and_relevant_points(content)
nodes_matrix = get_nodes_array(scores_matrix)
print(get_shortest_path(nodes_matrix, start_point, end_point))
